...
This is the starter code for the Amphibian app project. This project is an opportunity to
demonstrate the concepts learned in Unit 4 of Android Basics in Kotlin.
